...
func (NoticeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{0}
}
...
func (dst *NoticeData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NoticeData.Merge(dst, src)
}
...
func (*CreateNoticeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{1}
}
...
func (dst *CreateNoticeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateNoticeRequest.Merge(dst, src)
}
...
func (*DeleteNoticeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{2}
}
...
func (dst *DeleteNoticeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteNoticeRequest.Merge(dst, src)
}
...
func (*UpdateNoticeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{3}
}
...
func (dst *UpdateNoticeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNoticeRequest.Merge(dst, src)
}
...
func (*GetNoticeListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{4}
}
...
func (dst *GetNoticeListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNoticeListRequest.Merge(dst, src)
}
...
func (*GetNoticeListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_49e39b4df5242b86, []int{5}
}
...
func (dst *GetNoticeListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNoticeListResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("notice/notice.proto", fileDescriptor_notice_49e39b4df5242b86) }

var fileDescriptor_notice_49e39b4df5242b86 = []byte{
